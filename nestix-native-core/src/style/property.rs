...
impl StylePropertyName {
    pub fn name(self) -> &'static str {
        match self {
            ...
            Self::BorderHorizontalWidth => "border_horizontal_width",
            Self::BorderVerticalWidth => "border_vertical_width",
    ...
    pub(super) fn affected_names(self) -> &'static [&'static str] {
        match self {
            ...
            Self::BorderHorizontalWidth => &["border_left_width", "border_right_width"],
            Self::BorderVerticalWidth => &["border_top_width", "border_bottom_width"],
            Self::BorderLeftWidth => &["border_left_width"],
            Self::BorderRightWidth => &["border_right_width"],
            Self::BorderTopWidth => &["border_top_width"],
            Self::BorderBottomWidth => &["border_bottom_width"],
